...
public class AlarmReminderDbHelper extends SQLiteOpenHelper  {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String SQL_CREATE_ALARM_TABLE =  "CREATE TABLE " + AlarmReminderContract.AlarmReminderEntry.TABLE_NAME + " ("
                ...
                + AlarmReminderContract.AlarmReminderEntry.KEY_MEDICINE + " TEXT, "
                ...
                + AlarmReminderContract.AlarmReminderEntry.KEY_ROUTINE_DOSAGE + " TEXT, "
                + AlarmReminderContract.AlarmReminderEntry.KEY_REMINDER_STATUS + " TEXT, "
