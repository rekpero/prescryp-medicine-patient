...
public class AlarmReminderContract {
    ...
    public static final String CONTENT_AUTHORITY = "com.prescywallet.presdigi";
    ...
    public static final class AlarmReminderEntry implements BaseColumns {
        ...
        public final static String TABLE_NAME = "medicine_reminder";

        public final static String _ID = BaseColumns._ID;

        public static final String KEY_MEDICINE = "title";
        ...
        public static final String KEY_ROUTINE_DOSAGE = "routine_dosage";
