...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder>{
    ...
    public CartListAdapter(List<CartItem> listItems, Context context){
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.remove_cart_item.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new CartDbHelper(context).deleteCart(listItem.getMedicineName(), listItem.getPackageContain());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ImageView remove_cart_item;
